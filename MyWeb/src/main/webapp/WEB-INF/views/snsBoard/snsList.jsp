...
<body>
			...
			<div class="row">
				<aside class="col-sm-2">
					<div class="aside-inner">
						<div class="menu1">
							<p>
								<img src="../resources/img/profile.png">임뿅뿅
							</p>
							<ul>
								<li>내정보</li>
								<li>내쿠폰</li>
				...
				<div class="col-xs-12 col-sm-8 section-inner">
					...
					<div class="image-inner">
						...
						<img src="view?fileLoca=20201212&fileName=bearFamily.jpg">
	...
	<script>
		...
		$(document).ready(function() {
			...
			function regist() {
				var user_id = '${sessionsScope.user_id}'; //세션값
				...
				if(file != "jpg" && file != "png" && file != "bmp") {
					...
					$("#file").val(""); //file태그가 가지고있는 파일을 비우고 함수 종료
					return false;		
			...
			function getList(reset) {
				//1. getJSON을 통해서 DB에 저장되어있는 모든 값을 JSON형태로 전달받음
				//2. contentDiv영역안에 list개수만큼 회전해서 화면을 추가
				//3. 단 화면에 띄워야 하는 이미지영역에서는 src안에 view?값&값 호출하는 코드 작성
				str += "";
			}
